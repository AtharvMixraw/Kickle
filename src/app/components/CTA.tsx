          ...
          <div className="flex justify-center gap-4">
            {session?.user ? (
              <>
                <Link
                  href="/dashboard"
                  className="bg-[#00ff88] hover:bg-[#00dd77] text-black font-bold px-8 py-4 rounded-full transition transform hover:scale-105"
                >
                  Play Now - It&apos;s Free
                </Link>
                <Link
                  href="/leaderboard"
                  className="bg-gray-800 hover:bg-gray-700 text-white font-bold px-8 py-4 rounded-full transition"
                >
                  View Leaderboard
                </Link>
              </>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>
                  {session?.user ? (
                    ...
                    <button onClick={handleGoogleSignIn} className="hover:text-white transition">Play Daily Grid</button>
                  )}
                </li>
                <li>
                  {session?.user ? (
                    ...
                    <button onClick={handleGoogleSignIn} className="hover:text-white transition">Leaderboard</button>
                  )}
                </li>
                <li><a href="#" className="hover:text-white transition">Archive</a></li>
                <li><a href="#how-to-play" className="hover:text-white transition">How to Play</a></li>
              </ul>
            </div>
