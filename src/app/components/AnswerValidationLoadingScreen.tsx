...
export default function AnswerValidationLoadingScreen() {
    ...
    <div className="fixed inset-0 z-50 bg-background flex flex-col items-center justify-between py-16 px-6 overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-3xl">
        <div className="relative border-2 border-white p-6 bg-surface-container">
          <svg className="w-24 h-24 text-white animate-[spin_6s_linear_infinite]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <div className="w-full h-3 bg-surface-container border-2 border-surface-container-highest overflow-hidden">
          <div className="h-full bg-primary" style={{ animation: "progressLoad 3s ease-in-out infinite" }} />
        </div>

        <div className="text-center space-y-4 border-2 border-white p-6 bg-surface-container w-full">
          <p className="text-primary uppercase tracking-[0.2em] text-xs font-extrabold">Did you know?</p>
          <p
            className="text-white text-xl md:text-2xl font-extrabold leading-snug uppercase"
            style={{
              opacity: visible ? 1 : 0,
